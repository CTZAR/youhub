...
require 'youhub/models/asset_metadata'
...
module Youhub
  module Models
    ...
    class Asset < Base
      ...
      #   @return [Youhub::Models::Ownership] the asset’s ownership.
      has_one :ownership
      delegate :general_owners, :performance_owners, :synchronization_owners,
               :mechanical_owners, to: :ownership

      def metadata_mine
        @metadata_mine ||= Youhub::Models::AssetMetadata.new data: @data.fetch('metadataMine', {})
      end

      def metadata_effective
        @metadata_effective ||= Youhub::Models::AssetMetadata.new data: @data.fetch('metadataEffective', {})
      end
      ...
      # @return [Array<Youhub::Models::Tag>] the list of asset labels associated
      ...
      #   to download reports, or to filter YouTube Analyouhubics.
      has_attribute :label
