...
module Youhub
  module Models
    ...
    class Account < Base
      ...
      # @return [Youhub::Models::Video] the newly uploaded video.
      def upload_video(path_or_url, params = {})
        ...
        session.update(body: file) do |data|
          Youhub::Video.new id: data['id'], snippet: data['snippet'], status: data['privacyStatus'], auth: self
        end
      end

      # Creates a playlist in the account’s channel.
      # @return [Youhub::Models::Playlist] the newly created playlist.
      ...
      #   @return [Youhub::Collections::ContentOwners] the content owners that
      ...
      # @!attribute [r] channel
      #   @return [Youhub::Models::Channel] the YouTube channel of the account.
      has_one :channel

      # @!attribute [r] playlists
      #   @return [Youhub::Collections::Playlists] the playlists owned by the account.
      delegate :playlists, to: :channel

      # @!attribute [r] related_playlists
      #   @return [Youhub::Collections::Playlists] the playlists associated with the
      ...
      #   @return [Youhub::Collections::SubscribedChannels] the channels that the
      #     account is subscribed to.
      delegate :subscribed_channels, to: :channel

      # @!attribute [r] videos
      #   @return [Youhub::Collections::Videos] the videos owned by the account.
      has_many :videos

      # @!attribute [r] subscribers
      #   @return [Youhub::Collections::Subscribers] the channels subscribed to
      #     the account’s channel.
      has_many :subscribers

      # @!attribute [r] resumable_sessions
      #   @private
      #   @return [Youhub::Collections::ResumableSessions] the sessions used to
      #     upload videos using the resumable upload protocol.
      has_many :resumable_sessions

      # @!attribute [r] video_groups
      #   @return [Youhub::Collections::VideoGroups] the video-groups created by the
      #     account.
      ...
      def initialize(options = {})
        super options
        @user_info = UserInfo.new data: options[:user_info] if options[:user_info]
      end
