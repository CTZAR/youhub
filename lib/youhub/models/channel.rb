...
module Youhub
  module Models
    ...
    class Channel < Resource
      ...
      # @raise [Youhub::Errors::RequestError] if already subscribed.
      # @raise [Youhub::Errors::Unauthorized] if {Resource#auth auth} is not an
      #   authenticated Youhub::Account.
      def subscribe!
      ...
      #
      # @raise [Youhub::Errors::RequestError] if already unsubscribed.
      # @raise [Youhub::Errors::Unauthorized] if {Resource#auth auth} is not an
      #   authenticated Youhub::Account.
      def unsubscribe!
      ...
      # @!attribute [r] videos
      #   @return [Youhub::Collections::Videos] the channel’s videos.
      has_many :videos

      # @!attribute [r] playlists
      #   @return [Youhub::Collections::Playlists] the channel’s playlists.
      has_many :playlists
      ...
      #   @return [Youhub::Collections::SubscribedChannels] the channels that this
      #     channel is subscribed to.
      #   @raise [Youhub::Errors::Forbidden] if the owner of the channel has
      ...
      #   @raise [Youhub::Errors::Forbidden] if {Resource#auth auth} does not
      ...
      # @raise [Youhub::Errors::RequestError] if {Resource#auth auth} is not an
      #   authenticated Youhub::Account with permissions to update the channel.
