...
module Youhub
  module Models
    ...
    # @see https://www.youtube.com/youhub/playbook/annotations.html
    class Annotation < Base
      ...
      def has_link_to_subscribe?(_options = {}) # TODO: options for which videos
        link_class == '5'
      end
      ...
      def has_link_to_video?(_options = {}) # TODO: options for which videos
      ...
      def timestamp_of(position)
        regex = /(?:|(?<hours>\d*):)(?:|(?<min>\d*):)(?<sec>\d*)\.(?<ms>\d*)/
