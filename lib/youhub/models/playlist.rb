...
module Youhub
  module Models
    ...
    class Playlist < Resource
      ...
      #   authenticated Youhub::Account with permissions to delete the playlist.
      def delete(_options = {})
        do_delete { @id = nil }
        !exists?
      end
      ...
      # @raise [Youhub::Errors::Unauthorized] if {Resource#auth auth} is not an
      #   authenticated Youhub::Account with permissions to update the playlist.
      ...
      # @raise [Youhub::Errors::Unauthorized] if {Resource#auth auth} is not an
      #   authenticated Youhub::Account with permissions to update the playlist.
      # @return [Youhub::PlaylistItem] the item added to the playlist.
      ...
      # @param [Hash] options the options on how to add the video.
      # @option options [Integer] :position where to add video in the playlist.
      # @raise [Youhub::Errors::RequestError] if video can’t be added.
      # @raise [Youhub::Errors::Unauthorized] if {Resource#auth auth} is not an
      #   authenticated Youhub::Account with permissions to update the playlist.
      # @return [Youhub::PlaylistItem] the item added to the playlist.
      def add_video!(video_id, options = {})
      ...
      # @raise [Youhub::Errors::Unauthorized] if {Resource#auth auth} is not an
      #   authenticated Youhub::Account with permissions to update the playlist.
      # @return [Array<Youhub::PlaylistItem>] the items added to the playlist.
      ...
      #   @return [Youhub::Collections::PlaylistItems] the playlist’s items.
