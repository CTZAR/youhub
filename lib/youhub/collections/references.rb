...
require 'youhub/models/reference'

module Youhub
  module Collections
    # Provides methods to interact with a collection of Content ID references.
    #
    # Resources with references are: {Youhub::Models::ContentOwner content owners}.
    class References < Base
      ...
      def body_params
        %i[content_type audioswap_enabled ignore_fps_match excluded_intervals]
      end
    end
  end
end
