...
require 'youhub/models/resumable_session'
...
module Youhub
  module Collections
    ...
    #
    # Resources with resumable sessions are: {Youhub::Models::Account accounts}.
    #
    ...
    class ResumableSessions < Base
      ...
      # @param [Integer] content_length the size (byouhubes) of the object to upload.
