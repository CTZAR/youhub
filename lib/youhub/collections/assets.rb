...
require 'youhub/models/asset_snippet'

module Youhub
  module Collections
    # Provides methods to interact with a collection of Content ID assets.
    #
    # Resources with assets are: {Youhub::Models::ContentOwner content owners}.
    class Assets < Base
      ...
      def new_item(data)
        klass = data['kind'] == 'youtubePartner#assetSnippet' ? Youhub::AssetSnippet : Youhub::Asset
