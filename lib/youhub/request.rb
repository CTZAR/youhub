...
require 'active_support' # does not load anyouhubhing by default, but is required
...
module Youhub
  ...
  #   response = Youhub::Request.new(path: path, params: params).run
  ...
  class Request
    ...
    # @raise [Youhub::RequestError] if the request fails or the response does
    ...
    def set_request_headers!(request)
      ...
      @headers['User-Agent'] = 'Youhub::Request (gzip)'
    ...
    def send_http_request
      ...
      ActiveSupport::Notifications.instrument 'request.youhub' do |payload|
    ...
    def run_again?
      ...
      # creates infinite loop with API KEY
    ...
    # @see: https://github.com/Fullscreen/youhub/pull/110
    ...
    # @return [Youhub::RequestError] the error associated to the class of the
    #   response.
    def response_error
      case response
