...
describe Youhub::Video, :partner do
  subject(:video) { Youhub::Video.new id: id, auth: $content_owner }

  context 'given a video of a partnered channel', :partner do
    context 'managed by the authenticated Content Owner' do
      let(:id) { ENV['YOUHUB_TEST_PARTNER_VIDEO_ID'] }
      ...
      %i[views annotation_clicks annotation_click_through_rate
         card_impressions card_clicks card_click_rate
         card_teaser_impressions card_teaser_clicks card_teaser_click_rate
      ...
      describe 'views can be grouped by device type' do
        let(:range) { { since: ENV['YOUHUB_TEST_PARTNER_VIDEO_DATE'] } }
        let(:keys) { Youhub::Collections::Reports::DEVICE_TYPES.keys }
      ...
      describe 'views can be grouped by operating system' do
        let(:keys) { Youhub::Collections::Reports::OPERATING_SYSTEMS.keys }
      ...
      describe 'views can be grouped by YouTube product' do
        let(:keys) { Youhub::Collections::Reports::YOUTUBE_PRODUCTS.keys }
      ...
      describe 'views can be grouped by subscribed statuses' do
        let(:range) { { since: ENV['YOUHUB_TEST_PARTNER_VIDEO_DATE'] } }
        let(:keys) { Youhub::Collections::Reports::SUBSCRIBED_STATUSES.keys }
    ...
    context 'given a video claimable by the authenticated Content Owner' do
      let(:id) { ENV['YOUHUB_TEST_PARTNER_CLAIMABLE_VIDEO_ID'] }
