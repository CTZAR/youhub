...
describe Youhub::PlaylistItem do
  subject(:item) { Youhub::PlaylistItem.new attrs }
  ...
  describe '#video_id and #video' do
    context 'given a snippet with a video resource' do
      ...
      it { expect(item.video).to be_a Youhub::Models::Video }
  ...
  describe '#snippet' do
    context 'given fetching a playlist item returns a snippet' do
      ...
      it { expect(item.snippet).to be_a Youhub::Snippet }
    end
  end
  ...
  describe '#status' do
    context 'given fetching a playlist item returns a status' do
      ...
      it { expect(item.status).to be_a Youhub::Status }
    end
  end
