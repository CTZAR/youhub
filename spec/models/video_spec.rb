...
describe Youhub::Video do
  ...
  describe '#snippet' do
    context 'given fetching a video returns a snippet' do
      ...
      it { expect(video.snippet).to be_a Youhub::Snippet }
    end
  end
  ...
  describe '#age_restricted?' do
    context 'given a video with age restricted content' do
      let(:attrs) { { content_details: { 'contentRating' => { 'youhubRating' => 'youhubAgeRestricted' } } } }
    ...
    context 'given a video with a content rating but not youhubRating' do
